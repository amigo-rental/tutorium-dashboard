    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-white dark:bg-slate-900 lg:ml-4 xl:ml-0">
        ...
        <div className="pt-12 mb-8">
          ...
          <p className="text-black/70 dark:text-white/70 text-xl font-medium mt-2">
            Управляй своим профилем и аккаунтом
          </p>
        </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-black/70 dark:text-white/70 font-medium text-base">
                    Обнови свои личные данные
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Input
                ...
                classNames={{
                  ...
                  input: "font-medium text-black dark:text-white",
                  inputWrapper:
                    "bg-slate-100 dark:bg-slate-700 border-slate-200/60 dark:border-slate-600/60 shadow-none",
                }}
                label="Роль"
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-black/70 font-medium text-base">
                  Управляй интеграциями и уведомлениями
                </p>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-black/70 font-medium text-sm">
                        Переподключи свой аккаунт Telegram через бота
                      </p>
                    </div>
                  </div>
                  <Button className="font-bold text-white bg-[#0088CC] hover:bg-[#0088CC]/90 px-6">
                    Переподключить
                  </Button>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-black/70 font-medium text-sm">
                        Управляй важными обновлениями и напоминаниями
                      </p>
                    </div>
                  </div>
                  <Button
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/50">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[#EE7A3F]/10 rounded-xl flex items-center justify-center">
                    <svg
                      className="w-5 h-5 text-[#EE7A3F]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <path
                        d="M15 17h5l-5 5v-5zM4 19h6v-6H4v6zM4 5h6V4a1 1 0 00-1-1H5a1 1 0 00-1 1v1zm0 6h6V9H4v2zm0 4h6v-2H4v2z"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth={2}
                      />
