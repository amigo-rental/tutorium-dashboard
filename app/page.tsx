...
const courses = [
  {
    ...
    completedLessons: 18,
    coverImage:
      "https://media.docstorio.com/files/Marathon/331b0b7e-8bba-445a-90b9-87647beb640a.png",
  },
  {
    id: "2",
    ...
    completedLessons: 9,
    coverImage:
      "https://media.docstorio.com/files/Marathon/d3fe4838-a32f-4803-ac8f-880940f875ab.jpg",
  },
];
...
const pastLessons = [
  {
    ...
    message:
      "Great work on understanding the concept of limits. Next week we'll dive deeper into derivatives.",
    filesCount: 3,
    hasRecording: true,
    recordingUrl: "#",
  },
  {
    ...
    message:
      "Excellent analysis of Sonnet 18. Your interpretation showed deep understanding.",
    filesCount: 2,
    hasRecording: false,
  },
  {
    ...
    teacher: "Dr. Sarah Johnson",
    message:
      "Good progress on matrix operations. Keep practicing the exercises.",
    filesCount: 4,
    hasRecording: true,
    recordingUrl: "#",
  },
    ...
    <div className="min-h-screen bg-white lg:ml-4 xl:ml-0">
      ...
      <div className="space-y-8">
        ...
        <section className="relative">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-4xl font-bold text-black">Недавние уроки</h2>
              <p className="text-black/70 font-medium text-lg mt-1">
            ...
            <div className="p-6 bg-gradient-to-br from-[#007EFB]/5 via-[#EE7A3F]/5 to-[#FDD130]/5 border border-[#007EFB]/20 rounded-2xl">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-xs text-black/50 font-medium">
                  ...
                  Нажми на иконку копирования, чтобы скопировать ссылку в буфер
                  обмена
                </div>
              </div>
            </div>
            ...
            {selectedLesson && (
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl">
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${getLessonGradient(pastLessons.findIndex((l) => l.id === selectedLesson.id))} rounded-2xl flex items-center justify-center text-white font-bold text-xl`}
                  >
                    {pastLessons.findIndex((l) => l.id === selectedLesson.id) +
                      1}
                  </div>
                  <div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        startContent={
                          ...
                          >
                            <path
                              d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h6a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              strokeWidth={2}
                            />
