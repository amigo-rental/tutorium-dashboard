              ...
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-black text-base truncate">Елена Гарсия</h3>
                    <p className="text-black/70 font-medium text-sm truncate">Ученик</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <h4 className="font-bold text-black text-sm">Уведомления</h4>
                    <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                  </div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 text-xs">
                      <div className="w-2 h-2 bg-[#007EFB] rounded-full"></div>
                      <span className="text-black/70 font-medium">Новый урок</span>
                    </div>
                    <div className="flex items-center gap-2 text-xs">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-black/70 font-medium">Задание оценено</span>
                    </div>
                  </div>
                  <Button
                    size="sm"
